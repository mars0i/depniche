...
-- niche construction.  This earlier version doesn't enforce the rule
-- that the dunllins embedded in an environment with location loc just
-- also record the same location.

module Model1unenforcedLoctions where
